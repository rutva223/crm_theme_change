...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="font-20 ms-auto">
            ...
            @if (\Auth::user()->type == 'company')
                <a href="javascript:;" data-title="{{ __('Create New Lead') }}" class="btn btn-sm btn-primary btn-icon m-1" data-url="{{ route('lead.create') }}" data-ajax-popup="true" data-toggle="modal" data-target="#exampleModal">
