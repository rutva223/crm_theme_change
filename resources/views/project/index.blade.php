...
@section('content')
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="font-20 ms-auto">
            <a href="{{ route('project.grid') }}" class="btn btn-md btn-primary btn-icon m-1" data-bs-toggle="tooltip"
                data-bs-original-title="{{ __('Grid View') }}">
                <i class='bx bx-grid-alt text-white'></i>
            </a>
            @if (\Auth::user()->type == 'company')
                <a href="{{ route('project.create') }}" class="btn btn-md btn-primary btn-icon m-1"
                    data-bs-whatever="{{ __('Create New Project') }}" data-bs-toggle="tooltip"
                    data-bs-original-title="{{ __('Create') }}"> <i class="bx bx-plus text-white"></i> Add
                </a>
            @endif
        </div>
    </div>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="{{ route('project.show', \Crypt::encrypt($project->id)) }}"
                                                ...
                                                data-bs-original-title="{{ __('View') }}"> <span class="text-white">
