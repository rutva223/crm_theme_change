...
<?php $__env->startSection('content'); ?>
    <?php if(\Auth::user()->type == 'company'): ?>
        <div class="row">
            <?php if($data['pipelines'] <= 0): ?>
                <div class="col-3">
                    <div class="alert alert-danger">
                        <?php echo e(__('Please add constant pipeline.')); ?> <a href="<?php echo e(route('pipeline.index')); ?>"><b
                                class="text-white"><?php echo e(__('click here')); ?></b></a>
                    </div>
                </div>
            <?php endif; ?>
            <?php if($data['leadStages'] <= 0): ?>
                <div class="col-3">
                    <div class="alert alert-danger">
                        <?php echo e(__('Please add constant lead stage.')); ?> <a href="<?php echo e(route('leadStage.index')); ?>"><b
                                class="text-white"><?php echo e(__('click here')); ?></b></a>
                    </div>
                </div>
            <?php endif; ?>
            <?php if($data['dealStages'] <= 0): ?>
                <div class="col-3">
                    <div class="alert alert-danger">
                        <?php echo e(__('Please add constant deal stage.')); ?> <a href="<?php echo e(route('dealStage.index')); ?>"><b
                                class="text-white"><?php echo e(__('click here')); ?></b></a>
                    </div>
                </div>
            <?php endif; ?>
            <?php if($data['projectStages'] <= 0): ?>
                <div class="col-3">
                    <div class="alert alert-danger">
                        <?php echo e(__('Please add constant project stage.')); ?> <a href="<?php echo e(route('projectStage.index')); ?>"><b
                                class="text-white"><?php echo e(__('click here')); ?></b></a>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <div class="row">
                ...
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-primary"><?php echo e($data['totalClient']); ?></h5>
                            <div class="ms-auto">
        ...
        <?php if(\Auth::user()->type == 'company'): ?>
            <div class="col-4">
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-success"><?php echo e($data['totalEmployee']); ?></h5>
                            <div class="ms-auto">
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'client' || \Auth::user()->type == 'employee'): ?>
            <div class="col-4">
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-danger"><?php echo e($data['totalProject']); ?></h5>
                            <div class="ms-auto">
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'client'): ?>
            <div class="col-4">
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-danger"><?php echo e($data['totalEstimation']); ?></h5>
                            <div class="ms-auto">
                                <i class='bx bx-cart fs-3 text-danger'></i>
                            </div>
                        </div>
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'client'): ?>
            <div class="col-4">
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-danger"><?php echo e($data['totalInvoice']); ?></h5>
                            <div class="ms-auto">
                                <i class='bx bx-cart fs-3 text-danger'></i>
                            </div>
                        </div>
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'employee'): ?>
            <div class="col-4">
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-danger"><?php echo e($data['totalLead']); ?></h5>
                            <div class="ms-auto">
                                <i class='bx bx-cart fs-3 text-danger'></i>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress">
                            <?php $__currentLoopData = $data['estimationOverview']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estimation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="progress-bar bg-<?php echo e($data['estimateOverviewColor'][$estimation['status']]); ?>"
                                    role="progressbar" style="width: <?php echo e($estimation['percentage']); ?>%"
                                    aria-valuenow="<?php echo e($estimation['percentage']); ?>" aria-valuemin="0"
                        ...
                        <div class="row mt-3">
                            <?php $__empty_1 = true; $__currentLoopData = $data['estimationOverview']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estimation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-md-6">
                                    <span
                                        class="text-sm text-<?php echo e($data['estimateOverviewColor'][$estimation['status']]); ?>">●</span>
                                    <small><?php echo e($estimation['total']); ?> <?php echo e(__($estimation['status'])); ?> (<a
                                            href="#"
                                            class="text-sm text-muted"><?php echo e(number_format($estimation['percentage'], '2')); ?>%</a>)</small>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress">
                            <?php $__currentLoopData = $data['invoiceOverview']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="progress-bar bg-<?php echo e($data['invoiceOverviewColor'][$invoice['status']]); ?>"
                                    role="progressbar" style="width: <?php echo e($invoice['percentage']); ?>%"
                                    aria-valuenow="<?php echo e($invoice['percentage']); ?>" aria-valuemin="0"
                                    aria-valuemax="100"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="row mt-3">
                            <?php $__empty_1 = true; $__currentLoopData = $data['invoiceOverview']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-md-6">
                                    <span
                                        class="text-sm text-<?php echo e($data['invoiceOverviewColor'][$invoice['status']]); ?>">●</span>
                                    <small><?php echo e($invoice['total']); ?> <?php echo e(__($invoice['status'])); ?> (<a href="#"
                                            class="text-sm text-muted"><?php echo e(number_format($invoice['percentage'], '2')); ?>%</a>)</small>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="col-md-12 text-center">
                                    <div class="mt-3">
        ...
        <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'client'): ?>
            <div
                class="<?php echo e(\Auth::user()->type == 'employee' ? 'col-xl-6 col-md-6' : 'col-xl-4 col-md-6'); ?> dashboard-card">
                <div class="card radius-10 ">
                    <div class="card-body">
                        <div class="col-lg-12 text-center">
                        ...
                        <div class="progress">
                            <?php $__currentLoopData = $data['projects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="progress-bar bg-<?php echo e($data['projectStatusColor'][$k]); ?>" role="progressbar"
                                    style="width: <?php echo e($project['percentage']); ?>%"
                                    aria-valuenow="<?php echo e($project['percentage']); ?>" aria-valuemin="0"
                                    aria-valuemax="100"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="row mt-3">
                            <?php $__empty_1 = true; $__currentLoopData = $data['projects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-md-6">
                                    ...
                                    <small><?php echo e(__($project['status'])); ?> (<a href="#"
                                            class="text-sm text-muted"><?php echo e(number_format($project['percentage'], '2')); ?>%</a>)</small>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="col-md-12 text-center">
                                    <div class="mt-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right border-right">
                                <?php echo e(Form::open(['route' => ['employee.attendance'], 'method' => 'post'])); ?>

                                <?php if(empty($data['employeeAttendance']) || $data['employeeAttendance']->clock_out != '00:00:00'): ?>
                                    <?php echo e(Form::submit(__('CLOCK IN'), ['class' => 'btn btn-success btn-sm', 'name' => 'in', 'value' => '0', 'id' => 'clock_in'])); ?>

                                <?php else: ?>
                                    <?php echo e(Form::submit(__('CLOCK IN'), ['class' => 'btn btn-success btn-sm disabled', 'disabled', 'name' => 'in', 'value' => '0', 'id' => 'clock_in'])); ?>
                            ...
                            <div class="col-md-6 float-left">
                                <?php if(!empty($data['employeeAttendance']) && $data['employeeAttendance']->clock_out == '00:00:00'): ?>
                                    <?php echo e(Form::model($data['employeeAttendance'], ['route' => ['attendance.update', $data['employeeAttendance']->id], 'method' => 'PUT'])); ?>

                                    <?php echo e(Form::submit(__('CLOCK OUT'), ['class' => 'btn btn-danger btn-sm', 'name' => 'out', 'value' => '1', 'id' => 'clock_out'])); ?>

                                <?php else: ?>
                                    <?php echo e(Form::submit(__('CLOCK OUT'), ['class' => 'btn btn-danger btn-sm disabled', 'name' => 'out', 'disabled', 'value' => '1', 'id' => 'clock_out'])); ?>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="avatar rounded-circle">
                                                        <img alt=""
                                                            <?php if(!empty($invoice->clients) && !empty($invoice->clients->avatar)): ?> src="<?php echo e($profile . '/' . $invoice->clients->avatar); ?>" <?php else: ?>  avatar="<?php echo e(!empty($invoice->clients) ? $invoice->clients->name : ''); ?>" <?php endif; ?>
                                                            class="wid-25">
                                                    </a>
                                                    <div class="ms-3">
                                                        <small
                                                            class="text-muted"><?php echo e(\Auth::user()->invoiceNumberFormat($invoice->invoice_id)); ?></small>
                                                        <h6 class="m-0"><?php echo e(__('Due Amount : ')); ?>

                                                            <?php echo e(\Auth::user()->priceFormat($invoice->getDue())); ?></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td width="15%">
                                                <small class="text-muted"><?php echo e(__('Due Date')); ?></small>
                                                <h6 class="m-0"><?php echo e(\Auth::user()->dateFormat($invoice->due_date)); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $data['topDueProject']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td width="40%">
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-3">
                                                        <small class="text-muted"><?php echo e($project->dueTask()); ?>

                                                            <?php echo e(__('Task Remain')); ?></small>
                                            ...
                                            <td>
                                                <small class="text-muted"><?php echo e(__('Due Date')); ?></small>
                                                <h6 class="m-0"><?php echo e(\Auth::user()->dateFormat($project->due_date)); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $data['topDueTask']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topDueTask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td width="40%">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <small class="text-muted"><?php echo e(__('Assign to')); ?>

                                                            <?php echo e(!empty($topDueTask->taskUser) ? $topDueTask->taskUser->name : ''); ?></a></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <small class="text-muted"><?php echo e(__('Due Date')); ?></small>
                                                <h6 class="m-0">
                                                    <?php echo e(\Auth::user()->dateFormat($topDueTask->due_date)); ?></h6>
                                            </td>
                                            <td class="text-end">
                                                <div class="action-btn bg-warning ms-2">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $data['thisWeekEvent']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('assets/images/pages/flag.svg')); ?>"
                                            ...
                                            <td>
                                                ...
                                                <h6 class="m-0"><?php echo e($event->start_date . ' ' . $event->start_time); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $data['newTickets']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td width="40%">
                                                <div class="d-flex align-items-center">
                                                    <img alt="" class="avatar rounded-circle wid-25"
                                                        <?php if(!empty($ticket->createdBy)): ?> src="<?php echo e(asset(Storage::url('uploads/avatar')) . '/' . $ticket->createdBy->avatar); ?>" <?php else: ?>  avatar="<?php echo e(!empty($ticket->createdBy) ? $ticket->createdBy->name : ''); ?>" <?php endif; ?>>

                                                    <div class="ms-3">
                                                        <h6 class="m-0">
                                                            <?php echo e(!empty($ticket->createdBy) ? $ticket->createdBy->name : ''); ?>
                                            ...
                                            <td>
                                                ...
                                                <h6 class="m-0">
                                                    <?php echo e(\Auth::user()->dateFormat($ticket->created_at)); ?></h6>
                                            </td>
                                            <td width="20%">
                                                ...
                                                <h6 class="m-0">
                                                    <?php if($ticket->priority == 0): ?>
                                                        <span data-bs-toggle="tooltip"
                                                            data-bs-original-title="<?php echo e(__('Priority')); ?>"
                                                            class="text-capitalize badge badge-primary rounded-pill badge-sm">
                                                            <?php echo e(__(\App\Models\Support::$priority[$ticket->priority])); ?></span>
                                            ...
                                            <td>
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="<?php echo e(route('support.reply', \Crypt::encrypt($ticket->id))); ?>"
                                                        class="mx-3 btn btn-sm d-inline-flex align-items-center">
                                                        <i class="ti ti-eye text-white" data-bs-toggle="tooltip"
                                                            data-bs-original-title="<?php echo e(__('View')); ?>"></i>
                                                    </a>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $data['contractExpirySoon']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img alt=""
                                                        <?php if(!empty($contract->clients) && !empty($contract->clients->avatar)): ?> src="<?php echo e($profile . '/' . $contract->clients->avatar); ?>" <?php else: ?>  avatar="<?php echo e(!empty($contract->clients) ? $contract->clients->name : ''); ?>" <?php endif; ?>
                                                        class="wid-25">
                                                    <div class="ms-3">
                                                        <h6 class="m-0">
                                            ...
                                            <td>
                                                ...
                                                <h6 class="m-0">
                                                    <?php echo e(!empty($contract->types) ? $contract->types->name : '--'); ?></h6>
                                            </td>
                                            <td>
                                                <small class="text-muted"><?php echo e(__('Value')); ?></small>
                                                <h6 class="m-0"><?php echo e(\Auth::user()->priceFormat($contract->value)); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $data['newClients']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img alt=""
                                                        <?php if(!empty($client->avatar) && !empty($client->avatar)): ?> src="<?php echo e($profile . '/' . $client->avatar); ?>"
                                            <?php else: ?>  avatar="<?php echo e(!empty($client->name) ? $client->name : ''); ?>" <?php endif; ?>
                                                        class="wid-25">
                                            ...
                                            <td class="text-end">
                                                ...
                                                <h6 class="m-0">
                                                    <?php echo e(\Auth::user()->dateFormat($client->created_at)); ?></h6>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <div class="col-md-12 text-center">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\theme_change\crm_theme_change\resources\views/dashboard/index.blade.php ENDPATH**/ ?>