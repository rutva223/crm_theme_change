...
<?php $__env->startSection('content'); ?>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="font-20 ms-auto">
            <a href="<?php echo e(route('project.grid')); ?>" class="btn btn-md btn-primary btn-icon m-1" data-bs-toggle="tooltip"
                data-bs-original-title="<?php echo e(__('Grid View')); ?>">
                <i class='bx bx-grid-alt text-white'></i>
            </a>
            <?php if(\Auth::user()->type == 'company'): ?>
                <a href="<?php echo e(route('project.create')); ?>" class="btn btn-md btn-primary btn-icon m-1"
                    data-bs-whatever="<?php echo e(__('Create New Project')); ?>" data-bs-toggle="tooltip"
                    data-bs-original-title="<?php echo e(__('Create')); ?>"> <i class="bx bx-plus text-white"></i> Add
                </a>
            <?php endif; ?>
        </div>
    </div>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="<?php echo e(route('project.show', \Crypt::encrypt($project->id))); ?>"
                                                ...
                                                data-bs-original-title="<?php echo e(__('View')); ?>"> <span class="text-white">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\theme_change\crm_theme_change\resources\views/project/index.blade.php ENDPATH**/ ?>