...
<!--favicon-->
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('public/favicon_io/apple-touch-icon.png')); ?>">
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('public/favicon_io/favicon-16x16.png')); ?>">
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('public/favicon_io/favicon-32x32.png')); ?>">
<link rel="icon" type="image/png" sizes="192x192"
    href="<?php echo e(asset('public/favicon_io/android-chrome-192x192.png')); ?>">
<link rel="icon" type="image/png" sizes="512x512"
    href="<?php echo e(asset('public/favicon_io/android-chrome-512x512.png')); ?>">
<link rel="manifest" href="<?php echo e(asset('public/favicon_io/site.webmanifest')); ?>">
...
<link href="<?php echo e(asset('assets/select2/select2.min.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(asset('assets/select2/select2-bootstrap4.css')); ?>" rel="stylesheet" />
...
<link rel="stylesheet" href="<?php echo e(asset('assets/plugins/datepicker/bootstrap-datepicker.min.css')); ?>">
...
<link href="<?php echo e(asset('assets/css/imagemodel.css')); ?>" rel="stylesheet">
<?php /**PATH C:\laragon\www\theme_change\crm_theme_change\resources\views/partials/admin/head.blade.php ENDPATH**/ ?>