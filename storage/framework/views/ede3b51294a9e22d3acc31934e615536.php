        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Client Edit')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <?php echo e(Form::label('zip_code', __('Avatar'))); ?>
                                                                ...
                                                                <div class="col-lg-8">
                                                                    <div class="media align-items-center">
                                                                        <a href="#" class="avatar avatar-lg rounded-circle mr-3">
                                                                            <img <?php if(!empty($user->avatar)): ?> src="<?php echo e($profile . '/' . $user->avatar); ?>" <?php else: ?> avatar="<?php echo e($user->name); ?>" <?php endif; ?> class="avatar rounded-circle avatar-lg">
                                                                        </a>
                                        ...
                                        <form>
                                            <div class="row mt-3">
                                                <div class="col-sm-12 mb-3">
                                                    <div class="form-group">
                                                        <?php echo Form::label('clt_id', __('Client ID')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-sm-6 mb-3">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('tax_number', __('Tax Number'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\theme_change\crm_theme_change\resources\views/client/edit.blade.php ENDPATH**/ ?>