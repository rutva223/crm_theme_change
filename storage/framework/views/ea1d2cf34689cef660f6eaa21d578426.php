        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Employee Detail')); ?></li>
                </ol>
            </nav>
        </div>

        <div class="font-20 ms-auto">
            <a href="javascript:;" data-size="md" data-title="<?php echo e(__('Create New Employee')); ?>" class="btn btn-primary" data-url="<?php echo e(route('employee.create')); ?>" data-ajax-popup="true" data-toggle="modal" data-target="#exampleModal">
                    ...
                    <div class="row filter-css">
                        ...
                        <div class="col-auto">
                            <button type="submit" class="btn btn-xs btn-primary btn-icon-only rounded-circle"
                                data-toggle="tooltip" data-title="<?php echo e(__('Apply')); ?>"><i class="ti ti-search"></i></button>
                        </div>
                        <div class="col-auto">
                                        ...
                                        <?php if($employee->is_active == 1 && (\Auth::user()->id == $employee->id || \Auth::user()->type == 'company')): ?>
                                            <div class="dropdown action-item">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a href="javascript:;" data-size="md" data-title="<?php echo e(__('Reset Password')); ?>" class="dropdown-item" data-url="<?php echo e(route('employee.reset', \Crypt::encrypt($employee->id))); ?>" data-ajax-popup="true" data-toggle="modal" data-target="#exampleModal">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\theme_change\crm_theme_change\resources\views/employee/index.blade.php ENDPATH**/ ?>