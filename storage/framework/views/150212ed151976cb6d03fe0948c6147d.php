...
<?php $__env->startSection('content'); ?>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="font-20 ms-auto">
            <a href="<?php echo e(route('lead.index')); ?>" class="btn btn-md btn-primary btn-icon m-1" data-bs-toggle="tooltip"
                data-bs-original-title="<?php echo e(__('Kanban View')); ?>">
                <i class="ti ti-layout-kanban text-white"></i>
            </a>
            <?php if(\Auth::user()->type == 'company'): ?>
                <a href="javascript:;" data-size="md" data-title="<?php echo e(__('Create New Lead')); ?>" class="btn btn-primary"
                    data-url="<?php echo e(route('lead.create')); ?>" data-ajax-popup="true" data-toggle="modal"
                                ...
                                <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-right d-flex order-actions">
                                            <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'employee'): ?>
                                                <a href="<?php echo e(route('lead.show', \Crypt::encrypt($lead->id))); ?>" data-url="#" data-bs-whatever="<?php echo e(__('View Lead')); ?>" data-bs-toggle="tooltip" title="View Lead" data-bs-original-title="<?php echo e(__('View Lead')); ?>">
                                            ...
                                            <?php if(\Auth::user()->type == 'company'): ?>
                                                <a href="javascript:;" data-size="md" data-title="Edit Lead" class="ms-2"
                                                    data-url="<?php echo e(route('lead.edit', $lead->id)); ?>" style="color:blue"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\theme_change\crm_theme_change\resources\views/lead/grid.blade.php ENDPATH**/ ?>